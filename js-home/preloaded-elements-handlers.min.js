        ...
        2109: (e, t, n) => {
            ...
            r(r.S, 'Object', {
                getOwnPropertyDescriptors: function getOwnPropertyDescriptors(e) {
                    for (
                        var t, n, r = a(e), l = o.f, u = i(r), c = {}, f = 0;
                        u.length > f;
                        ...
                        (0, o.default)(Accordion, [
                            {
                                ...
                                value: function getDefaultSettings() {
                                    var e = (0, s.default)(
                                        (0, l.default)(Accordion.prototype),
                                        'getDefaultSettings',
                                        this
                                    ).call(this)
                                    return (0, i.default)(
                                        (0, i.default)({}, e),
                                        {},
                                        { showTabFn: 'slideDown', hideTabFn: 'slideUp' }
                                    )
                                },
                            },
                        ]),
                            ...
                            },
                            {
                                ...
                                value: function activateTab(e) {
                                    var t = this.getSettings(),
                                        ...
                                        i = this.elements.$tabContents.filter(
                                            '[data-tab="' + e + '"]'
                                        ),
                                    ...
                                    r.add(i).addClass(n),
                                        ...
                                        i[t.showTabFn](a, function () {
                                            return elementorFrontend.elements.$window.trigger(
                                                'resize'
                                            )
                                        }),
                                        i.removeAttr('hidden')
                                ...
                                value: function bindEvents() {
                                    ...
                                    this.elements.$tabTitles.on({
                                        keydown: function keydown(t) {
                                            jQuery(t.target).is('a') &&
                                                'Enter' === t.key &&
                                                t.preventDefault(),
                                                ['End', 'Home', 'ArrowUp', 'ArrowDown'].includes(
                                                    t.key
                                                    ...
                                                    for (; ;)
                                                        switch ((i.prev = i.next)) {
                                                            case 0:
                                                                ...
                                                                if (
                                                                    ((e = (0, l.default)(
                                                                        (0, u.default)(ImageCarousel.prototype),
                                                                        'onInit',
                                                                        this
                                                                    )).call.apply(e, [this].concat(n)),
                                                            ...
                                                            case 5:
                                                                return (
                                                                    (o = elementorFrontend.utils.swiper),
                                                                    (i.next = 8),
                                                                    new o(
                                    ...
                                    this.getElementSettings('lightbox') ||
                                        ('youtube' === this.getElementSettings('video_type')
                                            ? this.apiProvider.onApiReady(function (t) {
                                                e.elements.$imageOverlay.remove(),
                                                    e.prepareYTVideo(t, !0)
                                            })
                            ...
                            },
                            {
                                ...
                                value: function prepareYTVideo(e, t) {
                                        ...
                                        i = {
                                            ...
                                            events: {
                                                onReady: function onReady() {
                                                    r.mute && n.youtubePlayer.mute(),
                                                        (r.autoplay || t) && n.youtubePlayer.playVideo()
                                                },
                                                onStateChange: function onStateChange(t) {
                                                    t.data === e.PlayerState.ENDED &&
                                                        r.loop &&
                                                        n.youtubePlayer.seekTo(r.start || 0)
                                                },
                                            },
                                            playerVars: {
                                    ...
                                    r.yt_privacy &&
                                        ...
                                        (this.youtubePlayer = new e.Player(
                                            this.elements.$video[0],
                                            i
                                        ))
                                },
                            },
                                ...
                                value: function onInit() {
                                    ...
                                    if (
                                        ...
                                        ((this.apiProvider = elementorFrontend.utils.youtube),
                                            ...
                                            this.videoID &&
                                            (!t.show_image_overlay || !t.image_overlay.url))
                                    )
                                        return t.lazy_load
                                            ? ((this.intersectionObserver =
                                                elementorModules.utils.Scroll.scrollObserver({
                                                    callback: function callback(t) {
                                                        t.isInViewport &&
                                                            (e.intersectionObserver.unobserve(
                                                                e.elements.$video.parent()[0]
                                                            ),
                ...
                return [
                    ...
                    function (e) {
                        ...
                        for (var f, d = [], h = 0; null !== (f = o(l, u));) {
                            var v = String(f[0])
                                ; (d[h] = v),
                                    '' === v && (l.lastIndex = a(u, i(l.lastIndex), c)),
                                    h++
                        }
                        return 0 === h ? null : d
                    },
                ...
                return [
                    ...
                    function (e, t) {
                        ...
                        for (var b, w = '', _ = 0, x = 0; x < y.length; x++) {
                            ...
                            for (
                                var k = String(m[0]),
                                S = u(c(o(m.index), d.length), 0),
                                E = [],
                                T = 1;
                                T < m.length;
                                T++
                            )
                                E.push(void 0 === (b = m[T]) ? b : String(b))
                            var C = m.groups
                            if (h) {
                        ...
                        (a._invoke = (function makeInvokeMethod(e, t, n) {
                            ...
                            return function invoke(i, a) {
                                ...
                                for (n.method = i, n.arg = a; ;) {
                                    ...
                                    'throw' === h.type &&
                                        ((r = f), (n.method = 'throw'), (n.arg = h.arg))
                                }
                            }
                        })(e, n, o)),
                        a
