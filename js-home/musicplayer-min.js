        ...
        init: function () {
            ...
            for (var p in this.settings.elements)
                if ('volume' == this.settings.elements[p])
                    o +=
                        "<div class='volume'><div class='volume-btn' title='Volume'><i class='fas fa-volume-up'></i></div><div class=' volume-adjust'><div><div></div></div></div></div>"
                    ...
                    ; (r =
                        ...
                        (h =
                            '-1' != t.inArray('play', this.settings.controlElements)
                                ? "<div class='play'><i class='fas fa-play'></i></div><div class='pause'><i class='fas fa-pause'></i></div>"
                                : ' ')
            ...
            t(this.trackInfo).children('.title').text(i),
                ...
                this.song.addEventListener('timeupdate', function () {
                    t(l.timeCurrent).text(l.secondsToTime(this.currentTime)),
                        t(l.barPlayed).width((this.currentTime / this.duration) * 100 + '%')
                }),
